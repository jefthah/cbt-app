        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative">
                        <div class="w-full h-full flex shrink-0 rounded-full overflow-hidden">
                            <img src="{{ Storage::url($course->cover) }}" class="w-full h-full object-cover" alt="icon">
                        </div>
                        <p
                            class="z-10 p-[8px_16px] rounded-full bg-[#FFF2E6] font-bold text-sm text-[#F6770B] absolute bottom-0 transform -translate-x-1/2 left-1/2 text-nowrap">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center">
                            <div class="flex gap-[10px] items-center">
                                ...
                                <p class="font-semibold">{{ $correctAnswers }} of {{ $totalQuestions }} correct</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="result flex flex-col gap-5 mx-[70px] w-[870px] mt-[30px]">
                @foreach($course->questions as $question)
                    @php
                        $userAnswer = $studentAnswers->where('course_question_id', $question->id)->first();
                    @endphp
                    <div
                        ...
                        <div class="flex items-center gap-[14px]">
                            @if($userAnswer && $userAnswer->answer == 'Correct')
