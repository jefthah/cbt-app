        ...
        <nav class="flex items-center px-[50px] pt-[30px] w-full absolute top-0">
            ...
            <div class="flex items-center justify-end w-full">
                <ul class="flex items-center gap-[30px]">
                    <li>
                        <a href="" class="font-semibold text-white transition-all duration-300 hover:text-orange-400">Docs</a>
                    </li>
                    <li>
                        <a href="" class="font-semibold text-white transition-all duration-300 hover:text-orange-400">About</a>
                    </li>
                    <li>
                        <a href="" class="font-semibold text-white transition-all duration-300 hover:text-orange-400">Help</a>
                    </li>
        ...
        <div class="left-side min-h-screen flex flex-col w-full pb-[30px] pt-[82px]">
            <div class="h-full w-full flex items-center justify-center">
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-[30px] w-[450px] shrink-0">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            ...
                            <input type="email" value="{{ old('email') }}"
                                ...
                                placeholder="Write your correct input here" name="email" required autofocus>
                        </div>
                    </div>
                    <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('register') }}" class="text-center font-semibold text-[#7F8190]">Don't have an account? <span class="text-[#6436F1]">Sign Up</span></a>
                </form>
            </div>
        </div>
