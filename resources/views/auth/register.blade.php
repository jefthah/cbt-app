        ...
        <nav class="flex items-center px-[50px] pt-[30px] w-full absolute top-0">
            ...
            <div class="flex items-center justify-end w-full">
                <ul class="flex items-center gap-[30px]">
                    <li>
                        <a href=""
                            class="font-semibold text-white transition-all duration-300 hover:text-orange-400">Docs</a>
                    </li>
                    <li>
                        <a href=""
                            class="font-semibold text-white transition-all duration-300 hover:text-orange-400">About</a>
                    </li>
                    <li>
                        <a href=""
                            class="font-semibold text-white transition-all duration-300 hover:text-orange-400">Help</a>
                    </li>
                    <li class="h-[52px] flex items-center">
                        <a href="{{ route('login') }}"
                            class="font-semibold text-white p-[14px_30px] bg-[#0A090B] rounded-full text-center transition-all duration-300 hover:shadow-[0_4px_15px_0_#0A090B4D]">Sign
                            In</a>
                    </li>
                </ul>
            </div>
                ...
                <form method="POST" action="{{ route('register') }}"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            ...
                            <input type="text" value="{{ old('name') }}"
                                ...
                                placeholder="Write your correct input here" name="name" required autofocus>
                        </div>
                    </div>
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            ...
                            <input type="email" value="{{ old('email') }}"
                                class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                                placeholder="Write your correct input here" name="email" required>
                        </div>
                    </div>
                    <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div
                            ...
                            <input type="password"
                                class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                                placeholder="Write your correct input here" name="password_confirmation" required>
                        </div>
                    </div>
                    <button type="submit"
                    ...
                    <a href="{{ route('login') }}" class="text-center font-semibold text-[#7F8190]">Already have an
                        account? <span class="text-[#6436F1]">Sign In</span></a>
                </form>
            </div>
        </div>
