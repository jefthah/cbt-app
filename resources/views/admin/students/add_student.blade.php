        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a href="#" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Add Student</a>
                </div>
            </div>
            ...
            @if($errors->any())
                <div
                    class="alert alert-danger mx-[70px] mt-[30px] bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative">
                    <ul>
            ...
            <form method="POST" action="{{ route('dashboard.course.course_students.store', $course) }}" id="add-student"
