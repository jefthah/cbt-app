        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    <div class="relative">
                        <div class="w-[150px] h-[150px] flex shrink-0 overflow-hidden rounded-full">
            ...
            @if($errors->any())
                <div class="alert alert-danger mx-[70px] mt-[30px] bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative">
                    <ul>
            ...
            <form method="POST" action="{{ route('dashboard.courses_questions.update', $question) }}" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <input type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write the question" name="question" value="{{ $question->question }}">
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                            ...
                            <input type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write answer option" name="answers[]" value="{{ $answer->answer }}">
                        </div>
